...
- 🤖 **AI工具推荐**：快讯页底部展示AI工具卡片，支持分类、Logo、暗色主题
- 🔌 **REST API 发布**：支持 API Key 认证，可通过 curl 快速发布快讯
- 📱 **响应式设计**：适配桌面和移动端
- 🔍 **SEO 优化**：自定义页面标题、Meta description、关键词、面包屑导航
- 🏷️ **分类管理**：支持自定义分类和标签
- 📝 **分页支持**：时间线自动分页
...
### v1.8.0
- 优化底部AI工具推荐位前端样式
- 后台卡片样式选择（标准/紧凑/突出/简约）
- AI工具支持上传Logo图片
- 暗色主题自动适配

### v1.7.0
- 后台新增AI工具推荐管理页面
- 支持工具分类（AI写作/设计/编程/视频/音频/办公/对话等）
- 快讯页底部展示AI工具卡片
- 短代码 `[newsflash_recommend]` 可在任何页面调用
